...
export async function removeBackground(imageBuffer, options = {}) {
  try {
    ...
    // Photoroom automatically removes background and makes it transparent
    // No need to specify bg_color parameter
    ...
    console.log('Photoroom API success, response size:', response.data.length);
